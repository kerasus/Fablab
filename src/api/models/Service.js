...
export default class ServiceAPI extends APIRepository {
  constructor() {
    ...
    this.setCrudCallbacks({
      get: (response) => { return new Service(response.data) },
      post: (response) => { return new Service(response.data) },
      put: (response) => { return new Service(response.data) },
