  ...
  data () {
    ...
    return {
      ...
      inputs: [
        ...
        { type: 'input', name: 'slug', responseKey: 'slug', label: 'slug', placeholder: ' ', col: 'col-12' },
        { type: 'date', name: 'publish_date', responseKey: 'publish_date', placeholder: ' ', label: 'تاریخ انتشار', col: 'col-md-6 col-12' },
